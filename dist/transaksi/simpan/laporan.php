    ...
    <table align="center"  height="100px"  width="60%">
      <tr>
        ...
        <td align="center">
            ...
            <h4>Laporan Data Simpan File</h4>
    		</td>
		<td></td>
	   </tr>
     <tr>
    ...
    <tbody>
      <?php
        ...
        if (isset($_GET['dtgl'])&&isset($_GET['stgl'])) {
          ...
          $query = "SELECT sum(jml_simpan) as jml, simpan.*, jasa.*, jenis.*
                      FROM simpan, jasa, jenis
                      WHERE simpan.id_file = jasa.id_jasa
                      AND jenis.id_jenis = jasa.id_jenis
                      AND waktu_simpan BETWEEN '$dtgl' AND '$stgl'
                      GROUP BY simpan.id_file desc";
